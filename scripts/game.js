...
//Controla a colisão com o cenário
...
function Car() {
	...
	//--------------------------------------------metodos
	//------------------------------------------------------------------------------
	//Método: Muda a caixa de colisão do veículo conforme seu angulo na tela
	...
	//Método: Recupera a velocidade (constantes) do veículo com base na marcha atual
	...
	//Método: Atualiza a posição do carro com base em sua velocidade
	this.updatePosition = function (progress) {
		...
		} else if (vel == -1) { //Carro andando de Ré
...
function update(progress) {
	...
	function controlCarMovement(progress) {
		...
		//Atualiza a posição do carro com base em sua velocidade
		car.updatePosition(progress);


		//Verifica se houve intersecção com o foreground, caso positivo, torna-o transparente
...
/* 
	Author: João Paulo B. Faria
	Date: 01/12/2020
	Description: Carrega o background, por hora, tiles estáticos
*/
function renderBackground() {
	...
	function drawBackGroundOnScreen() {
		...
		//Informa que o background fora renderizado, de forma a não recarregar.
		isBgRendered = true;
	}
}
...
/* 
	Author: João Paulo B. Faria
	Date: 01/12/2020
	Description: Carrega os objetos de foreground e informa a renderização.
...
function renderForeground() {
	...
	//Desenha os objetos do cenário que ficarão em foreground (alguns magic numbers... :-( corrigir isso!)
